...
/**
 * PreciseDrawable provides a way to draw only a rectangle region of this drawable.
 */
public interface PreciseDrawable {

  /**
   * Draw a rectangle region {@code src} of this drawable in the destination region {@code `dst`}.
   */
